import { BoxGeometry, BufferAttribute, DoubleSide, FrontSide, Group, Mesh, MeshStandardMaterial, Object3D, Texture, TextureLoader, Vector2, } from "three";
...
export class SkinObject extends Group {
    constructor(hasBanner = false, bannerTexture = "") {
        super();
        // body parts
        ...
        Object.defineProperty(this, "hasBanner", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        // bannertexture is a objecturl
        Object.defineProperty(this, "bannerTexture", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        if (this.hasBanner) {
            const poleGeometry = new BoxGeometry(1, 27, 1);
            const poleTexture = new TextureLoader().load("https://i.imgur.com/SIiJ5Xe.jpeg");
            const poleMaterial = new MeshStandardMaterial({ map: poleTexture, side: DoubleSide });
            const pole = new Mesh(poleGeometry, poleMaterial);
            const poleTopGeometry = new BoxGeometry(12.5, 1, 1);
            const poleTopTexture = new TextureLoader().load("https://i.imgur.com/SIiJ5Xe.jpeg");
            const poleTopMaterial = new MeshStandardMaterial({ map: poleTopTexture, side: DoubleSide });
            const poleTop = new Mesh(poleTopGeometry, poleTopMaterial);
            const poleSmallGeometry = new BoxGeometry(1, 1, 1);
            const poleSmallMaterial = new MeshStandardMaterial({ color: "#96966e", side: DoubleSide });
            const poleSmall = new Mesh(poleSmallGeometry, poleSmallMaterial);
            const poleTopLeftSmallGeometry = new BoxGeometry(1, 1, 1);
            const poleTopLeftSmallMaterial = new MeshStandardMaterial({ color: "#96966e", side: DoubleSide });
            const poleTopLeftSmall = new Mesh(poleTopLeftSmallGeometry, poleTopLeftSmallMaterial);
            const poleTopRightSmallGeometry = new BoxGeometry(1, 1, 1);
            const poleTopRightSmallMaterial = new MeshStandardMaterial({ color: "#96966e", side: DoubleSide });
            const poleTopRightSmall = new Mesh(poleTopRightSmallGeometry, poleTopRightSmallMaterial);
            pole.position.y = 20;
            pole.position.z = -4.5;
            poleSmall.position.y = 32.5;
            poleSmall.position.z = -4.5;
            poleTopLeftSmall.position.x = 1;
            poleTopLeftSmall.position.y = 33.5;
            poleTopLeftSmall.position.z = -4.5;
            poleTopRightSmall.position.x = -1;
            poleTopRightSmall.position.y = 33.5;
            poleTopRightSmall.position.z = -4.5;
            poleTop.position.y = 33.5;
            poleTop.position.z = -4.5;
            const bannerGeometry = new BoxGeometry(12.5, 25, 0.5);
            const bannerTexture = new TextureLoader().load(this.bannerTexture);
            const bannerMaterial = new MeshStandardMaterial({ map: bannerTexture, side: DoubleSide });
            const banner = new Mesh(bannerGeometry, bannerMaterial);
            banner.position.y = 21.5;
            banner.position.z = -3.5;
            this.head.add(banner);
            this.head.add(pole);
            this.head.add(poleSmall);
            this.head.add(poleTopLeftSmall);
            this.head.add(poleTopRightSmall);
            this.head.add(poleTop);
        }
        this.add(this.head);
...
export class PlayerObject extends Group {
    constructor(banner, bannerTexture) {
        super();
        ...
        this.skin = new SkinObject(banner, bannerTexture);
        this.skin.name = "skin";
